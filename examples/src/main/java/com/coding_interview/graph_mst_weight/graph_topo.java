package com.coding_interview.graph_mst_weight;

// mstw.java
// demonstrates minimum spanning tree with weighted undirected graphs

// Put all the edges of current vertex in priority queue with distance
// It then takes the minimum distance edge and take out from priority queue.
// mark the destination vertex of above min edge to current vertex
// repeat the line 6 to 8
// remember the priority queue is same for all the itirations
...
class Vertex {
	...
	public String toString() {
		// TODO Auto-generated method stub
		return "label="+label+" isInTree="+isInTree;
	}
